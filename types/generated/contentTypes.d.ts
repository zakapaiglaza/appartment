...
export interface ApiAppartmentAppartment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    rent_records: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiRentRecordRentRecord extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    appartment: Schema.Attribute.Relation<
      'manyToOne',
      'api::appartment.appartment'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    appartments: Schema.Attribute.Relation<
      'oneToMany',
      'api::appartment.appartment'
    >;
